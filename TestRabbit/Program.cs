...
namespace TestRabbit
{
    ...
    class Program
    {
        static string connection = "amqp://bungkohm:nsowySUHXIZGkL1Bj4U9To8e-5te8fxi@barnacle.rmq.cloudamqp.com/bungkohm";//"amqp://xpsxyjse:nqXwuQgoRcJCp7yPMvRqSGLWEh7HEWwX@barnacle.rmq.cloudamqp.com/xpsxyjse";
        static string queueName = "queueOne";
